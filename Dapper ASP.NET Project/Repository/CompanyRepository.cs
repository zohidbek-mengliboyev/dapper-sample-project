...
namespace Dapper_ASP.NET_Project.Repository
{
    public class CompanyRepository : ICompanyRepository
    {
        ...
        public async Task<Company> GetCompanyByEmployeeId(int id)
        {
            ...
            paramaters.Add("Id", id, DbType.Int32, ParameterDirection.Input);

            using (var connection = _context.CreateConnection())
            {
                var company = await connection.QueryFirstOrDefaultAsync<Company>(procedureName, paramaters, commandType: CommandType.StoredProcedure);
